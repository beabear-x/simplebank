...
// Source: github.com/beabear/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) GetAccountBalance(arg0 context.Context, arg1 int64) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetEntryForUpdate(arg0 context.Context, arg1 int64) (db.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetSession(arg0 context.Context, arg1 []byte) (db.Session, error) {
	m.ctrl.T.Helper()
